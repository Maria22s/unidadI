	...
	<div class="contenido" align="center">
		<div class="formulario">
			<form id="FM" method="GET">
				<input type="hidden" name="crearEmpleado" value="saveEmpleados">
				<h1>Crear Empleados</h1>
				<div class="input-input">
					<input id="A_fname" name="fname" type="text" placeholder="Nombre">
					<p class="merror" id="B_fname">Nombre no debe tener caracteres numericos.</p>
					<input id="A_lname" name="lname" type="text" placeholder="Apellido">
					<p class="merror" id="B_lname">Apellido no debe tener caracteres numericos.</p>
				</div>
				<div class="input-input">
					<input id="A_telefono" name="telefono" type="text" placeholder="Teléfono">
				...
				<div class="input-input">
					<input id="A_salario" name="salario" type="text" placeholder="Salario">
